<?php
	...
	$ambilData=mysqli_query($koneksi,"SELECT * FROM tb_dosen WHERE nip='$nip'");
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<form action="home-user.php?page=edit-data-pegawai&nip=<?=$nip?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" name="telfon" class="form-control" value="<?=$hasil['telfon'];?>" maxlength="12">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-7">
								...
								<a href="home-user.php?page=form-view-data-pegawai" type="button" class="btn btn-default">Cancel</a>
							</div>
						</div>
					</div>
				</form>
